...
function showGameScoreLayer() {
    ...
    document.getElementById('GameScoreLayer-bast').innerHTML = '最高射精&nbsp;&nbsp;' + bast;
    l.style.display = 'block';
}
...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 39) return '希望你能成为像我一样优秀的人';
    if (score <= 79) return '你草了我，谁能证明？';
    if (score <= 119) return '我要发动全班同学孤立你？';
    if (score <= 159) return '你怎么这么有个性';
    if (score <= 199) return '你所热爱的，就是你的面具';
    return '恁就是任狗吧？';
}
